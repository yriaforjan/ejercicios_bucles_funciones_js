...
for (const track of tracks) {
    if (track.genre == "Metal") {
        songsByGenre.metal.push(track.title);
    } else if (track.genre == "Rock") {
        songsByGenre.rock.push(track.title);
    } else if (track.genre == "Pop") {
        songsByGenre.pop.push(track.title);
    } else if (track.genre == "Country") {
        songsByGenre.country.push(track.title);
    } else if (track.genre == "Grunge") {
        songsByGenre.grunge.push(track.title);
    }
}
